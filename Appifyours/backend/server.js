...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/boutique_app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '6a706bc19971af79ed7b7411',
...
app.listen(PORT, () => {
  ...
  console.log(`Boutique Backend Server running on port ${PORT}`);
